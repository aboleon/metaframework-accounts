    ...
    <table class="table table-striped table-bordered nowrap table-hover">
        <caption>
            @if (request()->has('sale_id'))
                ...
                <a href="{{ route('mfw-accounts.clients.dashboard', $client) }}">{{ __('mfw-accounts::ui.ClientAccount') }}</a>
            @endif
        </caption>
        <thead>
        <tr>
            ...
            <tr>
                ...
                <td>
                    <ul class="mfw-actions flex-nowrap">
                        ...
                        <li>
                            <a href="{{ url('mfw-accounts/pdf/'.$item->hash) }}" target="_blank"
                               class="btn btn-danger" title="PDF" data-bs-toggle="tooltip">
                        ...
                        <li>
                            <x-mfw::simple-modal
                                ...
                                confirm="{{ __('mfw-accounts::ui.Send') }}"
                                callback="bindSendInvoiceByMail"
                                :modelid="$item->id"
                            ...
                            <li>
                                <a href="{{ url('mfw-accounts/pdf/'.$d->hash) }}" target="_blank"
                                   class="label label-default flag" title="PDF" data-bs-toggle="tooltip">
                                    <img src="{{ asset('Modules/css/flags/'.$d->pdf_locale.'.png') }}" alt=""/>
                                </a>
                            </li>
                            <li>
                                <x-mfw::simple-modal
